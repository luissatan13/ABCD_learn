...
const INITIAL_LEVELS = [
  ...
  { id: 15, label: 'Sílabas J', type: 'silabas', target: 'J', status: 'locked', stars: 0 },
  { id: 16, label: 'Sílabas K', type: 'silabas', target: 'K', status: 'locked', stars: 0 },
  { id: 17, label: 'Sílabas N', type: 'silabas', target: 'N', status: 'locked', stars: 0 },
  { id: 18, label: 'Sílabas Ñ', type: 'silabas', target: 'Ñ', status: 'locked', stars: 0 },
  { id: 19, label: 'Sílabas Q', type: 'silabas', target: 'Q', status: 'locked', stars: 0 },
  { id: 20, label: 'Sílabas R', type: 'silabas', target: 'R', status: 'locked', stars: 0 },
  { id: 21, label: 'Sílabas T', type: 'silabas', target: 'T', status: 'locked', stars: 0 },
  { id: 22, label: 'Sílabas V', type: 'silabas', target: 'V', status: 'locked', stars: 0 },
  { id: 23, label: 'Sílabas W', type: 'silabas', target: 'W', status: 'locked', stars: 0 },
  { id: 24, label: 'Sílabas X', type: 'silabas', target: 'X', status: 'locked', stars: 0 },
  { id: 25, label: 'Sílabas Y', type: 'silabas', target: 'Y', status: 'locked', stars: 0 },
  { id: 26, label: 'Sílabas Z', type: 'silabas', target: 'Z', status: 'locked', stars: 0 },
  { id: 27, label: 'Repaso Difíciles', type: 'repaso', target: 'DIFFICULT', status: 'locked', stars: 0 },
];
